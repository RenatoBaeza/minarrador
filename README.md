...
| Transcription model        | `gemma4:12b`           | Audio-capable model used for speech-to-text |
...
- Transcription and summarisation run on your own machine via Ollama
...
- The app makes zero network requests beyond `127.0.0.1` (Ollama)
